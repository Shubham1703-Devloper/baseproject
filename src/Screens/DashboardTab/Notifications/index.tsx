...
const Menubar:React.FC<Props> = ({ onPress }) => {
  ...
  return (
    <ScrollView>
      <View style={styles.main1}>
        <Menubar onPress={(): void => props.navigation.openDrawer()} navigation={undefined} onToggleSnackBar={function (): void {
          throw new Error('Function not implemented.');
        } } onDismissSnackBar={function (): void {
          throw new Error('Function not implemented.');
        } } visible={false} handleConfirm={function (): void {
          throw new Error('Function not implemented.');
        } } />
      ...
      <View style={styles.main1}>
        <MyComponent
          ...
          onDismissSnackBar={onDismissSnackBar} navigation={undefined} onPress={function () {
            throw new Error('Function not implemented.');
